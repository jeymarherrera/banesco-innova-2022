    ...
    <div class="wrapper">
      ...
      <form class="form-wrapper">
        ...
        <h3>Ingrese los datos del representante</h3>
          <input type="text" name="name" id="name" placeholder="Nombre" required>
          <input type="text" name="lastname" id="lastname" placeholder="Apellido" required>
          <input type="text" name="id_representante" id="id_representante" placeholder="Cédula o Passaporte" required>
          <input type="text" name="phone" id="phone" placeholder="Télefono" required>
          <input type="text" name="email" id="email" placeholder="Correo" required>
          <input type="text" name="cargo" id="cargo" placeholder="Cargo" required>
          <input type="text" name="ciudadania" id="ciudadania" placeholder="Ciudadanía" required>
